...
*이 프로젝트는 RSS 피드를 통해 최신 뉴스를 수집하고, **Google Gemini **를 통해 요약해서 마크다운 문서로 만들어주는 자동화 도구입니다.*
...
- **뉴스저장 후 레포에 저장까지**: (선택 사항) 로컬의 다른 저장소나 GitHub 레포지토리로 자동 동기화하여 지식 베이스를 풍성하게 채워줍니다.
